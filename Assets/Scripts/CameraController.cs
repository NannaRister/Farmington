...
public class CameraController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        halfHeight = cam.orthographicSize; //projection i inspector vinduet på main camera - her 8, svarende til 8 bloks
    ...
    void Update()
    {
        ...
        //vi tilføjet halfWidth og halfHeight på metoderne
